...
export const POUPAI_GEMINI_CLIENT_VERSION = '2.6.1';
export const DEFAULT_GEMINI_READER_MODEL = process.env.POUPAI_GEMINI_READER_MODEL || 'gemini-3.6-flash';
export const DEFAULT_GEMINI_MARKET_MODEL = process.env.POUPAI_GEMINI_MARKET_MODEL || 'gemini-3.6-flash';
